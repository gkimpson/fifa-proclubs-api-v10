...
<div class="w-{{ $sizing[$size] }} h-{{ $sizing[$size] }} inline-block rounded-full ring-2 ring-gray-200 dark:ring-slate-600 ring-offset-2 overflow-hidden {{ $class }} @if ($stacked) -ml-5 @endif">
